...
export default function LiabilityClaimPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="gradient-bg text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">{t("liability.title")}</h1>
          <p className="text-lg opacity-90 max-w-2xl mx-auto">{t("liability.description")}</p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="input-label">{t("injuredPartyName")}</label>
                <input
                  type="text"
                  name="injuredPartyName"
                  value={form.injuredPartyName}
                  onChange={handleChange}
                  className="input-field"
                />
              </div>
              <div>
                <label className="input-label">{t("injuredPartyPhone")}</label>
                <input
                  type="tel"
                  name="injuredPartyPhone"
                  value={form.injuredPartyPhone}
                  onChange={handleChange}
                  className="input-field"
                />
              </div>
              <div>
                <label className="input-label">{t("injuredPartyAddress")}</label>
                <input
                  type="text"
                  name="injuredPartyAddress"
                  value={form.injuredPartyAddress}
                  onChange={handleChange}
                  className="input-field"
                />
              </div>
